...
;;
9)
echo -e "\e[31mERROR 9: Недостаточно прав для записи файла\e[0m" >&2
;;
10)
echo -e "\e[31mERROR 10: Файл скрипта не найдет или не существует\e[0m" >&2
;;
11)
echo -e "\e[31mERROR 11: Код завершения должен быть целым числом в диапазоне [0-255]\e[0m" >&2
;;
12)
echo -e "\e[31mERROR 12: Недостаточно доступа для создание файла в данной директории\e[0m" >&2
;;
esac
if [ -z $2 ]
then
